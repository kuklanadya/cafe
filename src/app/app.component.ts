...
export class AppComponent {
  ...
  constructor() {
    ...
    let dish2 = new Dish("strawberry pancakes", ["eggs", "flour", "milk", "honey", "strawberry", "syrup"], 45, TasteType.sweet, DishType.secondCourse);
    let dish3 = new Dish("croissant with chocolate", ["eggs", "flour", "butter", "yeast", "chocolate", "salt"], 25, TasteType.bitter, DishType.snack);
    let dish4 = new Dish("pizza 4 cheeses", ["chiken", "mozzarella", "parmesan", "gouda", "dor blue", "sauce"], 120, TasteType.salty, DishType.firstCourse);
